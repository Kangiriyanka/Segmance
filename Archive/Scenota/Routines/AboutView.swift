    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                infoCard(
                    title: "Our Mission",
                    description: "StageNote offers an intuitive way of creating routines for performances enjoyably.",
                    spacing: 12
                )
                ...
                infoCard(
                    title: "Who is StageNote for?",
                    description: "It's for anyone who wants to create a performance, create something with music. We just want you to enjoy the process.",
                    spacing: 12
                )
    ...
    func supportCard() -> some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading){
                ...
                Text("Enjoying the app? If you have time, reach out personally for support or to request features.")
                    .padding()
