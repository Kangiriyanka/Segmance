    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                infoCard(
                    title: "Why StageNote?",
                    description: "StageNote offers a simple and organized way of partitioning songs to brainstorm and practice for performances enjoyably.",
                    spacing: 12
                )
                ...
                infoCard(
                    ...
                    description: "It's for anyone who wants to create a performance.",
                    spacing: 12
                )
    ...
    func supportCard() -> some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading){
                ...
                Text("Enjoying the app? Please rate it, or reach out personally for support or request features.")
                    .padding()
